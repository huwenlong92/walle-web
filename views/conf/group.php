...
<div class="row">
    <div class="row col-sm-4">
        <h4 class="pink">
            ...
            <a href="#modal-form" role="button" class="blue" data-toggle="modal"> <span
                    class="green"><?= $conf->name ?></span> <?= yii::t('conf', 'relation') ?> </a>
        </h4>
    </div>
    ...
    <div class="row col-sm-4" style="margin-top: 5px;float:right;">
        ...
        <div class="input-group">
            <select multiple="" name="user[]" class="width-80 chosen-select" id="form-field-select-4"
                    data-placeholder="<?= yii::t('conf', 'search') ?>">
                <option value="">&nbsp;</option>
        ...
        <div class="itemdiv memberdiv">
            <div class="inline position-relative">
                <div class="user">
                    <a href="javascript:;">
                        <img
                            src="<?= Url::to('@web' . User::AVATAR_ROOT) . ($relation['user']['avatar'] ?: 'default.jpg') ?>">
                    </a>
                </div>
                ...
                <div class="body">
                    <div class="name">
                        <?php if ($relation['type'] == Group::TYPE_ADMIN) { ?>
                            <i class="icon-user-md light-orange bigger-110"
                               title="<?= yii::t('conf', 'audit manager') ?>"></i>
                        <?php } ?>
