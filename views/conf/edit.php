    ...
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <div class="radio" style="display: inline;" data-rel="tooltip"
                 data-title="<?= yii::t('conf', 'branch tip') ?>" data-placement="right">
                <label>
                    <input name="Project[repo_mode]"
                           value="<?= Project::REPO_MODE_BRANCH ?>" <?= $conf->repo_mode == Project::REPO_MODE_BRANCH ? 'checked="checked"' : '' ?>
                           type="radio" class="ace">
                    <span class="lbl"> branch </span>
                </label>
            </div>

            <div class="radio" style="display: inline;" data-rel="tooltip" data-title="<?= yii::t('conf', 'tag tip') ?>"
                 data-placement="right">
                <label>
                    <input name="Project[repo_mode]"
                           value="<?= Project::REPO_MODE_TAG ?>" <?= $conf->repo_mode == Project::REPO_MODE_TAG ? 'checked="checked"' : '' ?>
                           type="radio" class="ace">
                    <span class="lbl"> tag </span>
                </label>
            </div>

            <div id="div-repo_mode_nontrunk" class="radio"
                 style="display: <?php if ($conf->repo_type == Project::REPO_SVN) {
                     echo 'inline';
                 } else {
                     echo 'none';
                 } ?>;" data-rel="tooltip" data-title="<?= yii::t('conf', 'nontrunk tip') ?>" data-placement="right">
                <label>
                    <input name="Project[repo_mode]"
                           value="<?= Project::REPO_MODE_NONTRUNK ?>" <?= $conf->repo_mode == Project::REPO_MODE_NONTRUNK ? 'checked="checked"' : '' ?>
                           type="radio" class="ace">
        ...
        <div class="form-group">
            <label class="text-right bolder blue" for="form-field-2">
                ...
                <input name="Project[audit]" value="1" type="checkbox" <?= $conf->audit ? 'checked' : '' ?>
                       ...
                       data-title="<?= yii::t('conf', 'audit tip') ?>" data-placement="right">
                <span class="lbl"></span>
            </label>
        </div>
        ...
        <div class="form-group">
            <label class="text-right bolder blue" for="form-field-2">
                ...
                <input name="Project[ansible]" value="1" type="checkbox" <?= $conf->ansible ? 'checked' : '' ?>
                       class="ace ace-switch ace-switch-5" data-rel="tooltip"
                       data-title="<?= yii::t('conf', 'ansible tip') ?>" data-placement="right">
                <span class="lbl"></span>
            </label>
        </div>
        ...
        <div class="form-group">
            <label class="text-right bolder blue">
                ...
                <input name="Project[status]" value="1" <?= $conf->status ? 'checked' : '' ?> type="checkbox"
                       ...
                       data-title="<?= yii::t('conf', 'open tip') ?>" data-placement="right">
                <span class="lbl"></span>
            </label>
        </div>
